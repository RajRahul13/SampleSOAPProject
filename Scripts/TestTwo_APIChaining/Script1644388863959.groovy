...
response1 = WS.sendRequest(findTestObject('CountryInfoSOAPService/GetCountrylistSOAP'))
...
println('vaue of global variable ' + GlobalVariable.countryISOcode)

WS.sendRequest(findTestObject('CountryInfoSOAPService/GetCapitalSOAP'))
